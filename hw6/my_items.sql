...
CREATE TABLE `phones` (
  `id` int NOT NULL AUTO_INCREMENT,
  `phone_name` varchar(128) DEFAULT NULL,
...
INSERT INTO `phones` VALUES (1,'Xiaomi Poco X3 NFC ',1,2),(2,'Samsung Galaxy S20+ 5G',3,1),(3,'Apple iPhone 12 Pro',2,3);
...
-- Dump completed on 2021-05-20  3:45:10
